...
namespace Tespitler.Api.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class StatementsController : ControllerBase
    {
        private readonly TespitlerApiContext _context;

        public StatementsController(TespitlerApiContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Statements
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Statement>>> GetStatement()
        {
